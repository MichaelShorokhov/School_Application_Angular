...
export class GroupService {
  ...
  getAllGroups(): Observable<Group[]>{
    return this.http.get<Group[]>(this.ALL_GROUPS);
  }

  addGroup(group: Group) : Observable<Group>{
    return this.http.post<Group>(this.ADD_GROUP, group);
  }

  updateGroup(group: Group) : Observable<Group>{
    return this.http.post<Group>(this.UPDATE_GROUP, group);
  }

  deleteGroup(group: Group) : Observable<any>{
    return this.http.delete(this.DELETE_GROUP + group.id.toString());
  }
}
